...
class Quote:
    ...
    def _download_avatar(self, url, save_path):
        """
        Загружает изображение аватара по URL синхронно.
    ...
    def create(self, folder_name, avatar_name, result_filename, use_url=False,
        ...
        if use_url:
            # Скачиваем фото по URL синхронно
            avatar_path = os.path.join(folder_name, "avatar_from_url.jpg")
            self._download_avatar(avatar_name, avatar_path)
